...
public class DeckView<T> extends FrameLayout implements /*TaskStack.TaskStackCallbacks,*/
    ...
    @Override
    public DeckChildView createView(Context context,  T prepareData) {
//        Log.d(TAG, "createView");
        DeckChildView deckChildView = new DeckChildView(getContext());
        deckChildView.setFocusable(true);
        deckChildView.setContent(mCallback.getView(getContext(), prepareData));
...
//        mCallback.loadViewData(new WeakReference<DeckChildView<T>>(dcv), key);
    ...
    public interface Callback<T> {
        ...
        View getView(Context context, T item);
